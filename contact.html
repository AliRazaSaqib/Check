...
<div id="outer-div" ><!--main-div-strar-->
	...
	<a href="mailto:crystalvisionweb2@gmail.com">crystalvisionweb2@gmail.com</a>
                 ...
                 <form action="process.php" method="post" id="form1" name="form1" onsubmit="MM_validateForm('name','','R','phone','','R','email','','RisEmail','subject','','R','message','','R');return document.MM_returnValue">
                  ...
                  <table style="border: none;">
                    <tr>
                      <td colspan="2" style="text-align: left;" valign="bottom"><label for="name">Your Name:</label></td>
                    </tr>
                    <tr>
                      <td colspan="2" style="text-align: left;" valign="top"><input name="name" type="text" id="name" size="80" class="inputField" /></td>
                    </tr>
                    <tr>
                      <td colspan="2" style="text-align: left;" valign="bottom"><label for="phone">Phone NO.:</label></td>
                    </tr>
                    <tr>
                      <td colspan="2" style="text-align: left;" valign="top"><input name="phone" type="text" id="phone" size="80"  class="inputField"/></td>
                    </tr>

                    <tr>
                      <td colspan="2" style="text-align: left;" valign="bottom"><label for="email">Your E-mail:</label></td>
                    </tr>
                    <tr>
                      <td colspan="2" style="text-align: left;" valign="top"><input name="email" type="text" id="email" size="80" class="inputField"/></td>
                    </tr>
                    <tr>
                      <td colspan="2" style="text-align: left;" valign="bottom"><label for="subject">Subject:</label></td>
                    </tr>
                    <tr>
                      <td colspan="2" style="text-align: left;" valign="top"><input name="subject" type="text" id="subject" size="80" class="inputField" /></td>
                    </tr>
                    <tr>
                      <td colspan="2" style="text-align: left;" valign="bottom"><label for="message">Message:</label></td>
                    </tr>
                    <tr>
                      <td colspan="2" style="text-align: left;" valign="top"><textarea name="message" id="message" cols="60" rows="7"></textarea></td>
                    </tr>     
            <tr>
...
<div class="footer-box">
  ...
  <p><a href="index.html" class="foot-link">Home</a> | <a href="sitemap.html" class="foot-link">Site Map</a>|<a href="services.html" class="foot-link">Services</a>|<a href="contact.php" class="foot-link">Contact Us</a>|<a href="faqs.html" class="foot-link">FAQ</a></p>
  <hr style="color: #538baa" />
  <p class="copyrite">Copyright are reserved of this website@ <span><a href="">www.fcra.co.in</a></span><br />
  2011-2012</p></div>
  ...
  <p class="add">E-mail: <a href="mailto:crystalvisionweb2@gmail.com">crystalvisionweb2@gmail.com</a></p>            </div></div>
</body>
</html>
